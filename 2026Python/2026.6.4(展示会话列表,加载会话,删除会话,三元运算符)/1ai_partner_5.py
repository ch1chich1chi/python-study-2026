...
def load_sessions():
    session_list = []
    # 加载 目录下的文件
    if os.path.exists("F:/python的学习/AI智能伴侣聊天记忆"):
        file_list = os.listdir("F:/python的学习/AI智能伴侣聊天记忆")
...
def load_session(session_name):
    try:
        if os.path.exists(f"F:/python的学习/AI智能伴侣聊天记忆/{session_name}.json"):
        # 读取会话数据
            with open(f"F:/python的学习/AI智能伴侣聊天记忆/{session_name}.json","r",encoding="utf-8") as f:
...
def delete_session(session_name):
    try:
        if os.path.exists(f"F:/python的学习/AI智能伴侣聊天记忆/{session_name}.json"):
            os.remove(f"F:/python的学习/AI智能伴侣聊天记忆/{session_name}.json") # 删除文件
